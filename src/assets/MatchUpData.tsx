...
export const MatchUpData = [
    ...
    },
    {
        ...
        matchUps: [
            //#region COURT 1
            createMatchUp(1, 2, 3, 4, 1, 1),
            createMatchUp(17, 18, 19, 1, 1, 2),
            createMatchUp(8, 12, 16, 17, 1, 3),
            createMatchUp(4, 14, 8, 13, 1, 4),
            createMatchUp(7, 10, 13, 17, 1, 5),
            createMatchUp(3, 8, 11, 17, 1, 6),
            //#endregion

            //#region COURT 2
            createMatchUp(5, 6, 7, 8, 2, 1),
            createMatchUp(2, 5, 9, 13, 2, 2),
            createMatchUp(2, 18, 6, 19, 2, 3),
            createMatchUp(11, 17, 12, 18, 2, 4),
            createMatchUp(8, 16, 9, 18, 2, 5),
            createMatchUp(6, 9, 7, 19, 2, 6),
            //#endregion

            //#region COURT 3
            createMatchUp(9, 10, 11, 12, 3, 1),
            createMatchUp(3, 6, 10, 14, 3, 2),
            createMatchUp(1, 5, 10, 15, 3, 3),
            createMatchUp(3, 5, 16, 19, 3, 4),
            createMatchUp(1, 11, 14, 19, 3, 5),
            createMatchUp(10, 16, 12, 18, 3, 6),
            //#endregion

            //#region COURT 4
            createMatchUp(13, 14, 15, 16, 4, 1),
            createMatchUp(4, 7, 11, 15, 4, 2),
            createMatchUp(3, 9, 7, 4, 4, 3),
            createMatchUp(1, 6, 15, 2, 4, 4),
            createMatchUp(2, 4, 12, 5, 4, 5),
            createMatchUp(13, 15, 14, -1, 4, 6),
            //#endregion
        ]
    },
    {
        ...
        matchUps: [
            //#region COURT 1
            createMatchUp(1, 2, 3, 4, 1, 1),
            createMatchUp(9, 10, 1, 5, 1, 2),
            createMatchUp(4, 10, 8, 9, 1, 3),
            createMatchUp(1, 9, 2, 8, 1, 4),
            createMatchUp(2, 5, 7, 9, 1, 5),
            createMatchUp(1, 8, 4, 7, 1, 6),
            createMatchUp(6, 9, -1, -1, 1, 7),
            //#endregion

            //#region COURT 2
            createMatchUp(5, 6, 7, 8, 2, 1),
            createMatchUp(2, 3, 6, 7, 2, 2),
            createMatchUp(1, 3, 5, 6, 2, 3),
            createMatchUp(3, 4, 7, 10, 2, 4),
            createMatchUp(4, 6, 8, 10, 2, 5),
            createMatchUp(2, 3, 5, 10, 2, 6),
            //#endregion

            //#region COURT 3
            createMatchUp(11, 12, 13, 14, 3, 1),
            createMatchUp(19, 20, 11, 15, 3, 2),
            createMatchUp(14, 20, 18, 19, 3, 3),
            createMatchUp(11, 19, 12, 18, 3, 4),
            createMatchUp(12, 15, 17, 19, 3, 5),
            createMatchUp(11, 18, 14, 17, 3, 6),
            createMatchUp(16, 19, -1, -1, 3, 7),
            //#endregion

            //#region COURT 4
            createMatchUp(15, 16, 17, 18, 4, 1),
            createMatchUp(12, 13, 16, 17, 4, 2),
            createMatchUp(11, 13, 15, 16, 4, 3),
            createMatchUp(13, 14, 17, 20, 4, 4),
            createMatchUp(14, 16, 18, 20, 4, 5),
            createMatchUp(12, 13, 15, 20, 4, 6),
            //#endregion
        ]
    },
    {
        ...
        matchUps: [
            ...
            createMatchUp(4, 8, 12, 15, 1, 3),
            createMatchUp(4, 5, 11, 20, 1, 4),
            createMatchUp(3, 6, 20, 21, 1, 5),
            createMatchUp(11, 15, 17, 18, 1, 6),
            createMatchUp(11, 14, 16, 19, 1, 7),
            //#endregion

            //#region COURT 2
            createMatchUp(5, 6, 7, 8, 2, 1),
            createMatchUp(21, 1, 5, 9, 2, 2),
            createMatchUp(2, 16, 17, 21, 2, 3),
            createMatchUp(7, 9, 13, 17, 2, 4),
            createMatchUp(2, 5, 12, 14, 2, 5),
            createMatchUp(7, 12, 20, 21, 2, 6),
            createMatchUp(15, 17, 18, 20, 2, 7),
            //#endregion

            //#region COURT 3
            createMatchUp(9, 10, 11, 12, 3, 1),
            createMatchUp(2, 6, 10, 13, 3, 2),
            createMatchUp(1, 6, 14, 18, 3, 3),
            createMatchUp(3, 8, 16, 18, 3, 4),
            createMatchUp(4, 7, 10, 16, 3, 5),
            createMatchUp(1, 10, 9, 8, 3, 6),
            //#endregion

            //#region COURT 4
            createMatchUp(13, 14, 15, 16, 4, 1),
            createMatchUp(3, 7, 11, 14, 4, 2),
            createMatchUp(3, 5, 10, 19, 4, 3),
            createMatchUp(1, 12, 15, 19, 4, 4),
            createMatchUp(8, 9, 19, 13, 4, 5),
            createMatchUp(2, 4, 6, 13, 4, 6),
            //#endregion
        ]
    },
    {
